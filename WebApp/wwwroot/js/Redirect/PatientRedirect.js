    ...
    function RedirectController() {
        ...
        this.InitView = function () {
            ...
            $("#appointmentsMenuId").click(function () {
                this.RedirectToPage("/PatientAppointment", email);
            }.bind(this));

            // Redirección para Medical Report
            $("#medicalReportMenuId").click(function () {
                this.RedirectToPage("/Patient-MedicalReport", email);
            }.bind(this));
            $("#profileMenuId").click(function () {
                this.RedirectToPage("/Patient-UserProfile", email);
            }.bind(this));
            $("#settingsMenuId").click(function () {
                this.RedirectToPage("/Patient-Settings", email);
            }.bind(this));
        }
